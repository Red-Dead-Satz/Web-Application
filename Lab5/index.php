...
<html>
  ...
  <body>
    <div class="header">
      <div class="headerNameBox">
          <h3 class="headerName">Shaswat Chand</h3>
      </div>
      <div>
        <a href="login.php"><span class="material-icons headerLink">
    ...
    <div class="home">
      <div class="home_content">
        ...
        <h2 class="hobby">My hobby is watching sports documentaries</h2>
      </div>
    </div>
